...
from deep_research_agent_fixed import FixedDeepResearchAgent


async def main_fixed_v2(user_query: str) -> None:
    """修复版本v2的主函数"""
    print("🚀 启动修复版v2深度研究智能体...")
...
if __name__ == "__main__":
    ...
    try:
        asyncio.run(main_fixed_v2(query))
